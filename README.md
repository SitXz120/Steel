...
- Toggle DR Scramble ทำเควสต์ 5 Parts ด้วย: รับเควสต์จาก Escaped Experiment, เดินเก็บ Mechanical Gear และ Wiring Harness, เก็บอีก 3 ชิ้นจาก Drone แล้วกลับซ่อม Vault รับ The Scrambler ครั้งเดียว
- ชิ้นส่วนบนแผนที่และ Vault ทำได้ระหว่างรอบหุ่น เข้า–ออกถ้ำผ่านทางเข้าของเกม ยืนยันความคืบหน้าจากเซิร์ฟเวอร์ก่อนเปลี่ยนขั้นตอน และไม่รับรางวัลที่ Completed แล้วซ้ำ
- หน้า Event แสดงชิ้นส่วนบนแผนที่แยกแต่ละชิ้น, Drone Parts / 3 และสถานะรับรางวัล
- กิจกรรมไม่ซื้อของและไม่แลก Samples อัตโนมัติ
